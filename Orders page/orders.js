...
document.addEventListener('DOMContentLoaded', function() {
   ...
   // ... existing code ...
    ...
    function loadSampleOrders() {
                ...
                items: [
                    {
                        ...
                        price: 450000,
                        quantity: 1,
                        image: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?auto=format&fit=crop&w=120&q=60'
                    }
                ]
            },
            {
                ...
                items: [
                    {
                        ...
                        price: 280000,
                        quantity: 2,
                        image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=120&q=60'
                    }
                ]
            },
            {
        ...
        orders.forEach(o => { o.total = o.items.reduce((sum, it) => sum + (it.price * it.quantity), 0); });
...
// ... existing code ...
    ...
    function viewOrder(order) {
        ...
        const message = `سفارش ${order.number}\n` +
    ...
    function trackOrder(order) {
        ...
        showNotification(`پیگیری سفارش ${order.number} در حال بارگذاری است...`, 'info');
    ...
    function reorderItems(order) {
        ...
        try {
            ...
            showNotification(`اقلام سفارش ${order.number} به سبد خرید افزوده شد`, 'success');
    ...
    function cancelOrder(index) {
        ...
        if (!confirm(`آیا مطمئن هستید که می‌خواهید سفارش ${order.number} را لغو کنید؟`)) {
            return;
        }
    ...
    function applyFilters() {
        ...
        if (timeRange !== 'all') {
            filtered = filtered.filter(order => isWithinTimeRange(order.date, timeRange));
        }
    ...
    function updateStats() {
        if (!totalOrders || !pendingOrders || !shippedOrders || !deliveredOrders) return;
    ...
    function getTrackingInfo(order) {
        const trackingMap = {
            ...
            'processing': 'سفارش در حال پردازش است. تیم ما در حال آماده‌سازی سفارش شماست.',
            'shipped': 'سفارش ارسال شده است. شماره پیگیری: TRK' + order.id.padStart(6, '0'),
